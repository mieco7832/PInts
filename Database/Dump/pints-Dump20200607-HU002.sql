...
CREATE TABLE `detallefactura` (
  ...
  KEY `kfFactura` (`factura`),
  KEY `fkPrintura` (`pintura`),
  CONSTRAINT `fkPrintura` FOREIGN KEY (`pintura`) REFERENCES `pintura` (`idpintura`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `kfFactura` FOREIGN KEY (`factura`) REFERENCES `factura` (`numfactura`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `factura` (
  ...
  `subTatal` decimal(18,2) DEFAULT NULL,
  PRIMARY KEY (`numFactura`),
  KEY `fkPrivilegio` (`privilegio`),
  CONSTRAINT `fkPrivilegio` FOREIGN KEY (`privilegio`) REFERENCES `privilegio` (`idprivilegio`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-07 13:09:27
